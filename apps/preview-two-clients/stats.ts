...
const SAMPLES: { readonly [Tag in NetworkMessage['_tag']]: Extract<NetworkMessage, { _tag: Tag }> } = {
  AnvilCommand: { _tag: 'AnvilCommand', ...COMMAND_HEADER, name: 'Excalibur', slot: 0 },
  AnvilCommandAccepted: { _tag: 'AnvilCommandAccepted', commandId: COMMAND_ID, revision: 2 },
  AnvilCommandRejected: { _tag: 'AnvilCommandRejected', commandId: COMMAND_ID, reason: 'missing-iron', revision: 1 },
  ...
  BrewingCommand: { _tag: 'BrewingCommand', ...COMMAND_HEADER, action: { _tag: 'insert', slot: 0 }, at: { x: 1, y: 64, z: 0 } },
  BrewingCommandAccepted: { _tag: 'BrewingCommandAccepted', commandId: COMMAND_ID, revision: 2 },
  BrewingCommandRejected: { _tag: 'BrewingCommandRejected', commandId: COMMAND_ID, reason: 'missing-ingredients', revision: 1 },
  BrewingStandDelta: {
    _tag: 'BrewingStandDelta',
    at: { x: 1, y: 64, z: 0 },
    revision: 2,
    state: { bottle: 'water_bottle', fuelUnits: 4, ingredient: 'nether_wart' },
    world: OVERWORLD,
  },
  ...
  CraftingCommand: { _tag: 'CraftingCommand', ...COMMAND_HEADER, grid: { cells: ['stone', null, null, null], height: 2, width: 2 } },
  CraftingCommandAccepted: { _tag: 'CraftingCommandAccepted', commandId: COMMAND_ID, revision: 2 },
  CraftingCommandRejected: { _tag: 'CraftingCommandRejected', commandId: COMMAND_ID, reason: 'no-match', revision: 1 },
  DamageEnderDragonCommand: { _tag: 'DamageEnderDragonCommand', commandId: COMMAND_ID, expectedRevision: 1, player: ALICE },
  DamageEnderDragonCommandAccepted: { _tag: 'DamageEnderDragonCommandAccepted', commandId: COMMAND_ID, revision: 2 },
  DamageEnderDragonCommandRejected: { _tag: 'DamageEnderDragonCommandRejected', commandId: COMMAND_ID, reason: 'stale-revision', revision: 1 },
  DamageWitherCommand: { _tag: 'DamageWitherCommand', amount: 4, commandId: COMMAND_ID, expectedRevision: 1, kind: 'melee', player: ALICE, witherId: 'wither-1' },
  SummonWitherCommand: { _tag: 'SummonWitherCommand', commandId: COMMAND_ID, dimension: 'end', expectedRevision: 1, player: ALICE, position: { x: 0, y: 70, z: 0 } },
  WitherCommandAccepted: { _tag: 'WitherCommandAccepted', commandId: COMMAND_ID, revision: 2 },
  WitherCommandRejected: { _tag: 'WitherCommandRejected', commandId: COMMAND_ID, reason: 'invalid-command', revision: 1 },
  WitherSnapshotDelta: {
      ...
      withers: [
        {
          ...
          shotsFired: 0,
          state: { chargeRemainingSecs: 0, feetPosition: { x: 0, y: 70, z: 0 }, healthPoints: 300, phase: 'airborne', velocity: { x: 0, y: 0, z: 0 } },
        },
      ],
    },
  },
  EnchantingCommand: { _tag: 'EnchantingCommand', ...COMMAND_HEADER, offer: 1, slot: 0 },
  EnchantingCommandAccepted: { _tag: 'EnchantingCommandAccepted', commandId: COMMAND_ID, revision: 2 },
  EnchantingCommandRejected: { _tag: 'EnchantingCommandRejected', commandId: COMMAND_ID, reason: 'insufficient-lapis', revision: 1 },
  ...
  PlayerAnvilNamesDelta: { _tag: 'PlayerAnvilNamesDelta', names: [{ name: 'Excalibur', slot: 0 }], player: ALICE, revision: 2, world: OVERWORLD },
  PlayerDamageCommand: { _tag: 'PlayerDamageCommand', ...COMMAND_HEADER, amount: 4 },
  PlayerDamageCommandAccepted: { _tag: 'PlayerDamageCommandAccepted', commandId: COMMAND_ID, revision: 2 },
  PlayerDamageCommandRejected: { _tag: 'PlayerDamageCommandRejected', commandId: COMMAND_ID, reason: 'invalid-command', revision: 1 },
  PlayerEnchantmentsDelta: {
    _tag: 'PlayerEnchantmentsDelta',
    items: [{ item: { durability: null, enchantments: [{ id: 'sharpness', level: 1 }], item: 'iron_sword' }, slot: 0 }],
    player: ALICE,
    revision: 2,
    seed: 42,
    world: OVERWORLD,
  ...
  PlayerStatusEffectsDelta: {
    ...
    player: ALICE,
    revision: 2,
    state: { effects: [{ pulseClockSecs: 0.5, remainingSecs: 30, type: 'regeneration' }] },
    world: OVERWORLD,
  },
